...
@section('content')
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ Route('detail') }}" class="nav-item nav-link active">Détail sur le véhicule</a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Détail sur le véhicule</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="{{ Route('home') }}">Accueil</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Détail sur le véhicule </p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
