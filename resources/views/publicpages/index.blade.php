                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            <img class="img-fluid w-100" src="{{ asset('img/imgimg.png') }}" alt="">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="{{ Route('detail',['id'=> $vehicule->id]) }}" class="btn btn-sm text-dark p-0"><i
                                    class="fas fa-eye text-primary mr-1"></i>Voir plus</a>
                            <a href="{{ Route('doreservation',['id'=> $vehicule->id]) }}" class="btn btn-sm text-dark p-0"><i
        ...
        <div class="row px-xl-5">
            <div class="col">
                <div class="owl-carousel vendor-carousel">
                    ...
                    <div class="vendor-item border p-4">
                        <img src="{{ asset('img/vendor-10.jpg') }}" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="{{ asset('img/vendor-11.jpg') }}" alt="">
                    </div>
                    <div class="vendor-item border p-4">
                        <img src="{{ asset('img/vendor-12.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
