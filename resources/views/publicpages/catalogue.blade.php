...
@section('content')
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ Route('catalogue') }}" class="nav-item nav-link active">Catalogue</a>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Notre catalogue</h1>
            <div class="d-inline-flex">
                <p class="m-0"><a href="">Accueil</a></p>
                <p class="m-0 px-2">-</p>
                <p class="m-0">Notre Catalogue</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <div class="dropdown ml-4">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="triggerId">
                                    <a class="dropdown-item" href="#">Résecemment ajouté</a>
                                    <a class="dropdown-item" href="#">Popularité</a>
                                    <a class="dropdown-item" href="#">Mieux cotés</a>
                                </div>
                            </div>
                        </div>
                    </div>
